...
const ScrollArea = React.forwardRef<ScrollAreaElement, ScrollAreaProps>(
  (props: ScopedProps<ScrollAreaProps>, forwardedRef) => {
    ...
    const [viewport, setViewport] = React.useState<ScrollAreaViewportElement | null>(
      null,
    );
    const [content, setContent] = React.useState<HTMLDivElement | null>(null);
    const [scrollbarX, setScrollbarX] = React.useState<ScrollAreaScrollbarElement | null>(
      null,
    );
    const [scrollbarY, setScrollbarY] = React.useState<ScrollAreaScrollbarElement | null>(
      null,
    );
...
>((props: ScopedProps<ScrollAreaScrollbarImplProps>, forwardedRef) => {
  ...
  const [scrollbar, setScrollbar] = React.useState<ScrollAreaScrollbarElement | null>(
    null,
  );
