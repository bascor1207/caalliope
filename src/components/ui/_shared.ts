...
export const STYLES = {
  CONTENT_OVERFLOW_POPOVER:
    'z-50 overflow-hidden rounded-md border border-gray-200 bg-white text-gray-950 dark:border-gray-800 dark:bg-gray-950 dark:text-gray-50',
  ACCENT: 'focus:bg-gray-100 focus:text-gray-900 dark:focus:bg-gray-800 dark:focus:text-gray-50',
  ACCENT_FOCUS: 'focus:bg-gray-100 focus:text-gray-900 dark:focus:bg-gray-800 dark:focus:text-gray-50',
  ACCENT_STATE_OPEN: 'focus:bg-gray-100 data-[state=open]:bg-gray-100 dark:focus:bg-gray-800 dark:data-[state=open]:bg-gray-800',
  ...
  OFFSET_BG: 'ring-offset-white dark:ring-offset-gray-950',
  RING_FOCUS: 'focus:outline-none focus:ring-1 focus:ring-gray-950 focus:ring-offset-1 dark:focus:ring-gray-300',
  RING_FOCUS_VISIBLE:
    'focus-visible:ring-1 focus-visible:ring-gray-950 focus-visible:ring-offset-1 dark:focus-visible:ring-gray-300',
  ...
  TEXT_MUTED_PLACEHOLDER: 'placeholder:text-gray-500 dark:placeholder:text-gray-400',
  MARQUEE: 'pointer-events-none absolute from-white dark:from-background',
  // DATA STATES
  DATA_STATE_CHECKED:
    'data-[state=checked]:bg-gray-900 data-[state=checked]:text-gray-50 dark:data-[state=checked]:bg-gray-50 dark:data-[state=checked]:text-gray-900',
  DATA_STATE_TABS:
  ...
  // DEMOS
  DEMO_CARD:
    'relative flex min-h-[300px]  h-full w-full items-center justify-center rounded-lg border border-gray-200 bg-white p-20 md:shadow-xl overflow-hidden dark:border-gray-800 dark:bg-gray-950',
  DEMO_TITLE:
