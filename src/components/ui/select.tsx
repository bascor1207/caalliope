...
const SelectSeparator = clx(SelectPrimitive.Separator, "-mx-1 my-1 h-px bg-gray-100 dark:bg-gray-800");
...
const TriggerWrapper = clx(
  ...
  "h-10 w-full rounded-md bg-white px-3 py-2 text-sm  [&>span]:line-clamp-1 dark:bg-gray-950",
);
