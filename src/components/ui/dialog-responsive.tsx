...
const DialogRoot = clx(
  ...
  'max-w-lg border border-gray-200 bg-white shadow-lg duration-200  sm:rounded-lg dark:border-gray-800 dark:bg-gray-950',
);
...
const DialogCloseRoot = clx(
  ...
  STYLES.OFFSET_BG,
  STYLES.RING_FOCUS,
  'data-[state=open]:bg-gray-100 data-[state=open]:text-gray-500 dark:data-[state=open]:bg-gray-800 dark:data-[state=open]:text-gray-400',
