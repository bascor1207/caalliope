...
import { registerOnDetailsModalDisplayedForBookListener,
    registerOnLanguageChangeForBookListener, registerOnUpdateBookRatingForBookListener } from '@/modules/books/get-one-book/core/get-book.listeners';
...
export const createStore = (
  ...
  const store = configureStore({
    ...
    middleware(getDefaultMiddleware) {
        ...
        registerOnUpdateBookRatingForBookListener();
